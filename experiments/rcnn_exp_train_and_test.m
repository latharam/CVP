function [res_test, res_train] = rcnn_exp_train_and_test(method)
...
if k_folds > 0
  res_train = rcnn_test(rcnn_k_fold_model, imdb_train, method);
else
  res_train = [];
end

res_test = rcnn_test(rcnn_model, imdb_test,method);
